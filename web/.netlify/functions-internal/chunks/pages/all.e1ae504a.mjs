...
const css = {
	code: ":root{background-color:#141414}.horizontal.svelte-1fs05ss{display:flex;flex-direction:row;align-items:center;justify-content:center}.vertical.svelte-1fs05ss{display:flex;flex-direction:column;align-items:center;justify-content:center}.header.svelte-1fs05ss{margin-bottom:20px}",
	map: null
};
