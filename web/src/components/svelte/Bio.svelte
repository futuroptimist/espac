...
<div class="container">
    <div class="horizontal">
        {#each sites as s}
            <Chip inverted={true} small={true}>
                <a href={s.href}>
                    <div class="horizontal">
                        <span>{s.text}</span>
                        <SVG d={s.d} inverted={true} />
                    </div>
                </a>
            </Chip>
        {/each}
